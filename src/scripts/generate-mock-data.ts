...
import { Sensor, SensorType, createSensor, createEnvironmentalData, initializeDb } from '../models/environmentalData';


const generateSensorData = (sensorType: SensorType, timestamp: Date) => {
